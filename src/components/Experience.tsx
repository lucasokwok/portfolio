...
export function Experience() {
  ...
  return (
    <section ref={ref} id="experience" className="section-divider py-24 lg:py-32">
                ...
                >
                  ...
                  <div className="interactive-card rounded-xl border border-border bg-card p-6">
                    <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      ...
                      <span
                        className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-mono whitespace-nowrap ${
